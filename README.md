...
### Tech Stack 
## Backend & Frontend
- Next.js 176.1.6 (handles both frontend and backend)
...
3. Modern 
4. Type safe 
5. Quantum pharma uses this framework 
...
3. **What would you improve if this went to production?**
...
4. **How would you detect and debug issues after release?**
...
5. **What would you avoid changing in the first 30 days on a real platform?**
